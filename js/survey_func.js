...
jQuery(function ($) {
	...
	$('#universityClass').change(function () {
		
		if (this.value == '6') {
			$("#graduatedYear").show(200,function () {
                $("#graduatedYear").addClass("required");
            });
		} else {
			$("#graduatedYear").hide(200,function () {
                $("#graduatedYear").removeClass("required");
            });
		}
